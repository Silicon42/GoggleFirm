...
#endif
//---[Prototypes]-------------------------------------------------------------------------
float clamped_acos(float ratio);
// Vector math
...
void Quat_GetAxisAngle( quat *q, vec3 *axis, float *angle );
void Quat_ToEuler(quat *q1, float *heading, float *bank, float *attitude);
void QtoE(quat *q1, float *heading, float *bank, float *attitude);
#ifdef __cplusplus
}
#endif
#endif //_EXMATH_H
